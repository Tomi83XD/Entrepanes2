...
import { collection, query, onSnapshot, orderBy } from 'firebase/firestore'; // Importa funciones necesarias
    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between bg-yellow-500">
          <h2 className="text-2xl font-bold text-yellow-900">🛒 Tu Carrito</h2>
          <button onClick={onClose} className="text-yellow-900 hover:text-yellow-700 text-3xl">×</button>
        </div>
